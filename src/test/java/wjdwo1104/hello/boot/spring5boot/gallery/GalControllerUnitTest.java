package wjdwo1104.hello.boot.spring5boot.gallery;
...
public class GalControllerUnitTest {
    ...
    void writeok() throws Exception {
        ...
        String fpath = "c:/Java/zip.png";
        FileInputStream fis = new FileInputStream(fpath);

        MockMultipartFile attach = new MockMultipartFile("attachs","zip.png","image/png",fis);
