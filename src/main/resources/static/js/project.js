...
joinbtn?.addEventListener('click',()=>{
        ...
        else if (frm.repasswd.value ==='') alert('비밀번호확인를 입력하세요');
        else if (frm.zip1.value ==='' || frm.zip2.value ==='' ) alert('우편번호를 입력하세요');
        else if (frm.addr1.value ==='' || frm.addr2.value ==='') alert('주소를 입력하세요');
        else if (frm.email1.value ==='') alert('전자우편를 입력하세요');
        else if (frm.phone2.value ==='' || frm.phone3.value ==='') alert('폰번호를 입력하세요');
